        ...
        <div className="footer-grid" style={styles.grid}>
          ...
          <div style={styles.column}>
            ...
            <div style={styles.contactGroup}>
              ...
              <span style={styles.contactVal}>{config.address}</span>
            </div>
            <div style={styles.contactGroup}>
              <span style={styles.contactLabel}>Phone:</span>
              <a href={`tel:${config.phone.replace(/\s+/g, '')}`} style={styles.contactValLink}>{config.phone}</a>
            </div>
            <div style={styles.contactGroup}>
              <span style={styles.contactLabel}>Email:</span>
              <a href={`mailto:${config.email}`} style={styles.contactValLink}>{config.email}</a>
            </div>
          </div>
          ...
          <div style={styles.column}>
            ...
            <ul style={styles.branchList}>
              {config.branches.map((branch, idx) => (
                <li key={idx} style={styles.branchItem}>{branch}</li>
              ))}
            </ul>
          </div>
