    ...
    <nav style={styles.nav}>
      <div style={styles.container}>
        ...
        <Link to="/" style={styles.logo} onClick={() => setMobileMenuOpen(false)}>
          ...
          <span style={styles.logoText}>Park<span style={{ color: 'var(--highlight)' }}>Smart Ops</span></span>
        </Link>
              ...
              {dropdownOpen && (
                <div style={styles.dropdownMenu} className="glass-card" onClick={(e) => e.stopPropagation()}>
                  <div style={styles.dropdownHeader}>
                    ...
                    <span style={styles.roleBadge}>{user.role === 'operationadmin' ? 'OPERATIONS ADMIN' : user.role.toUpperCase()}</span>
                  </div>
            ...
            <div style={styles.modalBody}>
              ...
              <div style={styles.profileMeta}>
                ...
                <span style={styles.profileRoleBadge}>
                  {user.role === 'operationadmin' ? 'OPERATIONS ADMIN' : user.role.toUpperCase()}
                </span>
              </div>
