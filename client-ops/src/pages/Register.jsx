...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res && res.success) {
      toast.success(res.message || 'Registration successful! Your account is pending Super Admin approval.');
      navigate('/login');
    } else {
    ...
    <div className="page-wrapper" style={styles.container}>
      <div style={styles.card} className="glass-card animate-fade-in">
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>Set up admin credentials to access operations management</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div className="form-group">
            ...
            <select
              ...
              required
            >
              <option value="operationadmin">Operations Admin</option>
